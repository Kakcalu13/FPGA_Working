...
# Load FPGA program
dev.OpenBySerial("")
dev.ConfigureFPGA("C:/Users/Rajkumar/PycharmProjects/qDVS_export/qDVS.bit")
...
if eventmode:
    ...
    dac.vdac_program_single_daisy(dev, 1, 6, 0.0)  # NBIAS_OFF 0.0
    dac.vdac_program_single_daisy(dev, 1, 7, 0.0)  # NBIAS_ON 0.0
else:
    ...
    try:
        ...
        for read_cnt in range(1):
            ...
            if eventmode:
                ...
                aq_image[x,y] = 2*p #0.2*p + 0.8*aq_image[x,y]
